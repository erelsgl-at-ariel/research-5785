...
# single_plot_results("results/demo1.csv", filter={"z": 6}, x_field="x", y_field="sum", z_field="y", mean=False, save_to_file="results/demo1.png")
    # Should show a scatter-plot with six points.

# single_plot_results("results/demo1.csv", filter={}, x_field="x", y_field="sum", z_field=["y","z"], save_to_file="results/demo1.png")
